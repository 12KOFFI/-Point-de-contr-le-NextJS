...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center bg-white dark:bg-gray-900 px-4 sm:px-6 py-16 md:py-20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16 xl:gap-24">
          ...
          <div className="text-center lg:text-left flex-1">
            ...
            <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              ...
              <a
                ...
                download
                className="px-5 py-2.5 sm:px-6 sm:py-3 border border-gray-300 dark:border-white text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-white/10 font-medium sm:font-semibold rounded-full text-sm sm:text-base transition-colors"
              >
                {t.downloadCV}
              </a>
            </div>
            ...
            <div className="mt-8 sm:mt-10 md:mt-12 flex flex-wrap justify-center lg:justify-start gap-2 sm:gap-3">
              {["nextjs", "react", "tail", "nodejs"].map((tech) => (
                <div
                  key={tech}
                  className="bg-gray-100 dark:bg-white/10 p-1.5 sm:p-2 rounded-md sm:rounded-lg transition-colors"
                >
                  <Image
          ...
          <div className="flex-1 flex justify-center mb-8 lg:mb-0">
            <div className="relative w-56 h-56 xs:w-64 xs:h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-xl overflow-hidden shadow-2xl shadow-blue-500/20">
              <Image
